# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-13 12:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=120, unique=True, verbose_name='Заголовок категории')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('viewsNum', models.IntegerField(default=0, verbose_name='Количество просмотров')),
                ('likesNum', models.IntegerField(default=0, verbose_name='Количество лайков')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=120, unique=True, verbose_name='Заголовок тега')),
            ],
        ),
        migrations.AddField(
            model_name='question',
            name='status',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='questions.Status'),
        ),
        migrations.AddField(
            model_name='question',
            name='tags',
